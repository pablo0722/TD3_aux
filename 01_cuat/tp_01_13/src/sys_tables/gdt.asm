...
Gdt_desc_tss0_sel: istruc gdtd_t         ; Instancia Gdt_desc_tss0_sel de la estructura gdtd_t
               ...
               at gdtd_t.attr,      db 11101001b   				; Atributos. present | max prvl  | 0 | data segment | Direction GrowUp | writable | Accesed
               at gdtd_t.lim_attr,  db 00001111b   				; Lim_attr
...
istruc tss_intel_t 		; vector de la estructura task_status_t
	...
	at tss_intel_t.esp0, 		dd 0x0000
	at tss_intel_t.reserved2, 	dw 0x0000
	at tss_intel_t.ss0, 		dw 0x0000
	...
	at tss_intel_t.cr3, 		dd __STACK_TAREA_NIVEL0_LIN
	...
	at tss_intel_t.iobp_offset, dw 0x0000
