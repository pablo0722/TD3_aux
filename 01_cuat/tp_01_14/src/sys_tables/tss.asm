...
EXTERN CODE_SEL0
EXTERN DATA_SEL0
EXTERN __STACK_TAREA_NIVEL3_LIN_END
EXTERN CODE_SEL3
EXTERN DATA_SEL3
...
istruc tss_custom_t 		; vector de la estructura tss_custom_t
	...
	at tss_custom_t.esp3, 	dd __STACK_TAREA_NIVEL3_LIN_END
	at tss_custom_t.ss3, 	dw DATA_SEL3
	at tss_custom_t.esp0, 	dd __STACK_TAREA_NIVEL0_LIN_END
	at tss_custom_t.ss0, 	dw DATA_SEL0
...
istruc tss_custom_t 		; vector de la estructura tss_custom_t
	...
	at tss_custom_t.edi, 	dd 0
	at tss_custom_t.eip, 	dd __TAREA_TEXT_LIN
	at tss_custom_t.cs, 	dw CODE_SEL3
	at tss_custom_t.esp3, 	dd __STACK_TAREA_NIVEL3_LIN_END
	at tss_custom_t.ss3, 	dw DATA_SEL3
	at tss_custom_t.esp0, 	dd __STACK_TAREA_NIVEL0_LIN_END
	at tss_custom_t.ss0, 	dw DATA_SEL0
