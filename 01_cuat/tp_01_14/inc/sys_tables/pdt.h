 ...
 * 					SYS_TABLES 					*
 ************************************************/
extern PDE * pdt_tarea0	__MY_DATA__ ALIGN(4);
extern PTE * pt_tarea0 	__MY_DATA__ ALIGN(4);

extern PDE * pdt_tarea1	__MY_DATA__ ALIGN(4);
extern PTE * pt_tarea1 	__MY_DATA__ ALIGN(4);

extern PDE * pdt_tarea2	__MY_DATA__ ALIGN(4);
extern PTE * pt_tarea2 	__MY_DATA__ ALIGN(4);
