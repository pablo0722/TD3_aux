 ...
 * 					SYS_TABLES 					*
 ************************************************/
extern IdtGate 	idt_gates[IRQ_CANT] __SYS_TABLES__ ALIGN(8);
extern Idtr 	idtr 				__SYS_TABLES__ ALIGN(8);
 ...
 * 					FUNCIONES 					*
 ************************************************/
__KFUNCTION__ void _load_idt();
__KFUNCTION__ void _isr_load(IdtGate *idt_gate, void (*isr)(void), word segment, dword dpl, IdtType type);
