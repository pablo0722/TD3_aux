...
_init16:
	...
	.TEST_OK:
		...
		mov	esi,	__SHDW_GDT16_ORG ; DS:si = origen
		mov	edi,	__SHDW_GDT16_DST ; es:di = destino
	...
	.LLE1: 		; Local Loop End
		...
		mov	si,	__SHDW_INIT32_ORG ; DS:si = origen
		mov	di,	__SHDW_INIT32_DST ; es:di = destino
